...
exports.enrichLeadsWithEmail = void 0;
 ...
 */
const enrichLeadsWithEmail = async (leads) => {
    ...
    const enrichedLeads = await Promise.all(leads.map(async (lead) => {
        ...
        let currentLead = Object.assign({}, lead);
        // Stage 1: Search Engine (Find Website if missing)
        if (!currentLead.website) {
            const searchResults = await (0, searchEngine_1.searchEngineDiscovery)(currentLead);
            currentLead = Object.assign(Object.assign({}, currentLead), searchResults);
        }
        ...
        if (!currentLead.email && currentLead.website) {
            const dataResults = await (0, dataProvider_1.dataProviderEnrichment)(currentLead);
            ...
            currentLead = Object.assign(Object.assign({}, currentLead), dataResults);
        }
...
exports.enrichLeadsWithEmail = enrichLeadsWithEmail;
