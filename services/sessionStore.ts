export const sessionStore = {
    ...
    createVirtualSourceObject(scrapedData: { businessName: string, industry: string, keywords: string[], location: string }) {
    ...
    async startReimagineSession(data: { originalUrl?: string, virtualSource?: any, seoScore?: number, variants?: string[], emailCampaigns?: string[] }) {
    ...
    async _runStandardOrchestration(url: string, providedVariants?: any[]) {
    ...
    async _runVirtualOrchestration(source: any) {
